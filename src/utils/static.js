// Comment variables please update this file when DB has new enum attributes

export const statusOptions = {
  publisherStatus: ['Pending', 'Approved', 'Declined', 'Suspended', 'Closed'],
  merchantStatus: ['Approved', 'Paused', 'Closed'],
  networkStatus: ['Visible', 'Invisible'],
  campaignStatus: ['Active', 'Inactive'],
  membershipStatus: ['Pending', 'Declined', 'Approved'],
  websiteStatus: ['Verified', 'Unverified', 'Inactive', 'None'],
  trackingStatus: ['Approved', 'Paused', 'Closed', 'Pending', 'Declined', 'Suspended'],
  transactionStatus: ['Approved', 'Pending', 'Declined', 'Verify', 'SoftDecline'],
  userStatus: ['Active', 'Pending', 'Inactive'],
  adStatus: ['Active', 'Pending', 'Disabled', 'Expired'],
  productStatus: ['Active', 'Inactive'],
}

export const constOptions = {
  gender: ['Mostly Male', 'Mostly Female', 'Any Gender'],
  market: [
    'US only',
    'US and Canada',
    'Canada only',
  ...
  age: ['All ages', 'Under 18', '18-24', '25-34', '35-44', '45+'],
  income: [
    'N/A',
    'Under 30,000',
    '$30,000 - $40,000',
  ...
  subCategories: (productCategory) => {
    switch (productCategory) {
      case 'Credit Cards':
        return ['Travel', 'Cash back', 'Rewards', 'Low rate', 'No annual fee', 'Student', 'Secure']
      case 'Banking':
        return ['Savings', 'Chequing']
      case 'Mortgage':
        return ['Term', 'Fixed or Variable', 'Heloc', 'Refinancing']
      case 'Investments':
        return ['Registered', 'Non-Registered', 'TFSA', 'Robo-Advisor', 'Self-Directed', 'GICs']
      case 'Insurance':
        return [
          'Health',
          'Life',
  ...
  minimumPayable: (paymentMethod, currency) => {
    let minimumAmount = 0
  ...
  payment: ['Cheque', 'Cheque Payment for $1000', 'Paypal', 'Wire Transfer'],
  commissionVisibility: ['Member only', 'Hide'],
  signupBonusVisibility: ['Show Network', 'Hide'],
  membersOfferVisibility: ['Show Members only', 'Hide'],
  statsFrequency: ['Every 24 hours'],
  statsFrequencyVisibility: ['Show Members only', 'Hide'],
  cookieDurationVisibility: ['Show Members only', 'Hide'],
  tracked: ['All Sales', 'Publisher Sales only'],
  anyEnglishSpeakingCountries: ['United States', 'Canada', 'Australia'],
  roleType: ['Admin', 'Merchant', 'Publisher'],
  commissionType: ['CPA - Cost per Action', 'Referral', 'Revenue Share', 'Bonus'],
  commissionIsDefault: [
    'Default - All Members qualify for this commission',
    'Custom - Only select members/groups qualify for this commission',
  ],
  commissionStructure: ['Use Flat Commission', 'Use Tiered Commission'],
  commissionBase: ['Gross Sales', 'Net Sales'],
  adTypes: ['ALL', 'BANNER', 'TEXT/TRACKING', 'HTML5'],
  feeTypes: ['Setup Fee', 'Other'],
  depositTypes: ['Paypal', 'Cheque', 'Wire Transfer'],
  transactionReportColumns: [
    ...
    'Transaction Note',
    'Tracking Profile ID',
    'Tracking Profile URL',
    'Referral URL',
    'IP Address',
    'User OS/Browser',
    'User Agent',
  ],
  transactionReportColumnsVertical: [
    'Transaction ID',
    'Order ID',
    'New Transaction',
    'Transaction Date',
  ...
  // merchantTransactionReportColumns: [
  //   'Transaction ID',
  //   'Transaction Date',
  //   'Transaction Processed Date',
  //   'Transaction Status',
  ...
  //   'User Agent',
  // ],
  merchantTransactionReportColumnsVertical: [
    'Transaction ID',
    'Customer ID',
    'Processed by',
    'Transaction Date',
  ...
  // publisherTransactionReportColumn: [
  //   'Transaction ID',
  //   'Transaction Date',
  //   'Transaction Processed Date',
  //   'Transaction Status',
  ...
  //   'User Agent',
  // ],
  publisherTransactionReportColumnVertical: [
    'Transaction ID',
    'Customer ID',
    'Transaction Country',
    'Transaction Date',
  ...
  ruleNamesByCategory: (productCategory) => {
    let ruleNames = []
    switch (productCategory) {
      case 'Credit Cards':
        ruleNames = [
...
export const sortByOptions = {
  publisher: ['ID', 'Name', 'Registration Date'],
  merchant: ['ID', 'Name', 'Registration Date'],
  product: ['Product ID', 'Product Name', 'Last Updated'],
  membership: ['ID', 'Name', 'Application Date', 'Registration Date', 'Status'],
  program: ['ID', 'Name', 'Status'],
  user: ['Name', 'Role', 'Status', 'Last Login'],
  ...
  pubAndGroups: ['Accepted Date', 'Selected', 'Type'],
  commissionDate: ['Start Date', 'End Date'],
  accountBalanceDetails: ['Date', 'Type'],
}

export const showOptions = {
  membershipStatic: ['All Statuses', 'Pending', 'Approved', 'Declined', 'Closed'],
  market: [
    'All',
...
export const transactionOptions = {
  status: ['Approved', 'Pending', 'Declined', 'Verify', 'SoftDecline'],
}
